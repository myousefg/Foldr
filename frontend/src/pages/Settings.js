  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-2xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Configure monitoring, naming, and output.</p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <FolderInput
          ...
          description="Rule destination folders (e.g. 'Documents') are relative to this path. Leave blank to use your home directory."
      ...
      <section className="space-y-4">
        ...
        <ToggleRow
          ...
          description="Strip camera codes (IMG_, DSC_), copy markers, and normalise spacing in rename templates."
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Used when a rule has no template of its own. Tokens:&nbsp;
          ...
          <code className="bg-muted px-1 rounded text-[11px]">{'{category}'}</code>
        </p>
        <Input
